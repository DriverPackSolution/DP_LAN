...
ipfnd51.sys           Windows XP NDIS 5.1 driver

fSetXP.exe            Auto-install utility for Windows XP NDIS 5.1 driver
...
------------------------------------------------
    ...
    ------------------------------------------
    The following steps can help you install or update the driver by
    fSetXP.exe utility in the Adapter Drivers Diskette/CD-ROM.

     a. Make sure fSetXP.exe utility with all driver files in same folder.

     b. Run fSetXP.exe directly. Then the screen will display :
        "Found Adapter and install/update successfully!"
    ...
    the one in the Adapter Drivers Diskette/CD-ROM.
     ...
     f. The wizard will be warning you as the driver without digital 
        signatured. Click "Continue" to continue.
